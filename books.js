...
function Books(){
document.getElementById('otherBooks').style.display='none'
document.getElementById('books__main').style.display='block'
}
function Home(){
  document.getElementById('otherBooks').style.display='block'
  document.getElementById('books__main').style.display='none'
}
// FAKE DATA
function getBooks() {
